...
class RegisterForm(Form):
    login = StringField('login', validators=[Required('This filed is required')])
    email = StringField('email', validators=[Required('This field is required'), Email('Please, enter valid email')])
